...
<head>
	<meta charset="utf-8" />
	<title>Loteria | Panel Administrador</title>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed">
		...
		<div id="header" class="header navbar-default">
			...
			<div class="navbar-header">
				<a href="index.html" class="navbar-brand"><span class="navbar-logo"></span> <b>Lot</b>eria</a>
			...
			<div data-scrollbar="true" data-height="100%">
				...
				<ul class="nav">
					...
					<li class="has-sub ">
						...
						<ul class="sub-menu">
						    <li><a href="usuarios/crear.php" >Crear Nuevo Usuario</a></li>
						    <li><a href="usuarios/editar.php" >Editar Usuarios</a></li>
		...
		<div id="content" class="content">
			...
			<ol class="breadcrumb pull-right">
				...
				<li class="breadcrumb-item active"><a href="javascript:;">Panel Administrador</a></li>
			</ol>
			<!-- end breadcrumb -->
			<!-- begin page-header -->
			<h1 class="page-header">Panel Administrador <small>Bienvenido...</small></h1>
			<!-- end page-header -->
			<!-- begin row -->
			<div class="row">
			    <!-- begin col-3 -->
